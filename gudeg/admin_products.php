...
<section class="show-products">
   ...
   <h1 class="heading">produk ditambahkan
</h1>
   ...
   <div class="box">
      ...
      <div class="flex-btn">
         ...
         <a href="admin_products.php?delete=<?= $fetch_products['id']; ?>" class="delete-btn" onclick="return confirm('hapus produk ini?');">hapus</a>
      </div>
   </div>
   <?php
         }
